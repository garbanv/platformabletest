...
const IndexPages = ({ data }) => {
  ...
  const trendsData = [
    {
      title:"Open Banking/Open Finance Trends Report in the world war 2 of russian and ukrain",
      date:"January 2022",
...
{/*         <br />
      ...
      <div className="container mx-auto">
        <div className="my-5">
        <h3 className="text-2xl font-bold">Check out our latest releasesXXX</h3>
        </div>
      <div
      ...
      >
        ...
        {trendsData.map((trend,index)=>{
          return (
             ...
             <div className="rounded-xl  h-full bg-homepage-latest-releases border shadow-xl ">
            <div className="text-center px-5">
            <p className="font-sm text-center py-3">{trend.date}</p>
    ...
    <section className="trends-homepage bg-sunglow  py-10">
      <div className="container mx-auto">
        <div className="my-5">
        <h3 className="text-center text-2xl font-bold">Check out our latest releases</h3>
        </div>
      <div
      ...
      >
        ...
        {trendsData.map((trend,index)=>{
          return (
            ...
            <h6 className="font-bold text-center  text-white  h-16 ">{trend.title}</h6>
            <div className="text-center">
            {trend?.download && <a
            className={`md:inline-block inline-block 
            ${trend.btnBackground} text-sm md:text-primary 
      ...
      <section className="cards-section my-2 container py-2 sm:mx-auto md:px-0 px-5">
        <div className="px-0 md:px-3 lg:px-0 xl:px-3">
          <h2 className="text-center font-bold mb-5 mt-6">Latest Posts </h2>
